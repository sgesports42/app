const username = localStorage.getItem('sg_local');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzC2HNSbbchqSwNEzgSy7x1519n_AkMmF9kFXHYUVwYLgi09Z-2_jtXjeRolRICyVWz/exec';
...
async function uploadToImgur(file) {
    ...
    const response = await fetch('https://api.imgur.com/3/image', {
        method: 'POST',
        headers: {
            'Authorization': 'Client-ID d96563492bd3854'
        },
        body: formData
    });
